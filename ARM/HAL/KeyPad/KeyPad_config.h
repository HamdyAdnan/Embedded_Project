...
#define KEYPAD_R0_PORT    PORTA_ID
#define KEYPAD_R0_PIN     PIN4_ID

#define KEYPAD_R1_PORT    PORTA_ID
#define KEYPAD_R1_PIN     PIN5_ID

#define KEYPAD_R2_PORT    PORTA_ID
#define KEYPAD_R2_PIN     PIN6_ID

#define KEYPAD_R3_PORT    PORTA_ID
#define KEYPAD_R3_PIN     PIN7_ID

#define KEYPAD_C0_PORT    PORTB_ID
#define KEYPAD_C0_PIN     PIN11_ID

#define KEYPAD_C1_PORT    PORTB_ID
#define KEYPAD_C1_PIN     PIN10_ID

#define KEYPAD_C2_PORT    PORTB_ID
#define KEYPAD_C2_PIN     PIN1_ID

#define KEYPAD_C3_PORT    PORTB_ID
#define KEYPAD_C3_PIN     PIN0_ID
